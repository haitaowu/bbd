...
/** 对象方法 (Block 创建 SGAlertView ) */
- (instancetype)initWithTitle:(NSString *)title contentTitle:(NSString *)contentTitle alertViewBottomViewType:(SGAlertViewBottomViewType)alertViewBottomViewType didSelectedBtnIndex:(SGAlertViewBlock)didSelectedBtnIndex {
    if (self = [super init]) {
        self.frame = [UIScreen mainScreen].bounds;
        self.backgroundColor = [UIColor clearColor];
        
        self.messageTitle = title;
        self.block_SG = didSelectedBtnIndex;
...
/** 类方法 (Block 创建 SGAlertView )*/
+ (instancetype)alertViewWithTitle:(NSString *)title contentTitle:(NSString *)contentTitle alertViewBottomViewType:(SGAlertViewBottomViewType)alertViewBottomViewType didSelectedBtnIndex:(SGAlertViewBlock)didSelectedBtnIndex {
    return [[self alloc] initWithTitle:title contentTitle:contentTitle alertViewBottomViewType:alertViewBottomViewType didSelectedBtnIndex:didSelectedBtnIndex];
}
