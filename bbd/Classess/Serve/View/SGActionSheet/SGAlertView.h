...
typedef void(^SGAlertViewBlock)(SGAlertView *alertView, NSInteger index);
...
@property (nonatomic, copy) SGAlertViewBlock block_SG;
...
#pragma mark - - - Block（推荐使用）
/** 对象方法 (Block 创建 SGAlertView 取消按钮的 index 为 0) */
...
/** 类方法 (Block 创建 SGAlertView 取消按钮的 index 为 0)*/
